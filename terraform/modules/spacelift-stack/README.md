...
| <a name="input_spacelift_github_integration_id"></a> [spacelift\_github\_integration\_id](#input\_spacelift\_github\_integration\_id) | The ID of the GitHub integration to use for this stack. Defaults to the Default Integration if not specified | `string` | `null` | no |
